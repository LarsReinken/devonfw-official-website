...
[[meta-architecture.asciidoc]]
= Meta Architecture

[[meta-architecture.asciidoc_introduction]]
== Introduction

[[meta-architecture.asciidoc_purpose-of-this-document]]
...
[[meta-architecture.asciidoc_goal-of-the-client-architecture]]
...
[[meta-architecture.asciidoc_architecture-views]]
=== Architecture Views
...
[[meta-architecture.asciidoc_devonfw-reference-client-architecture]]
...
[[meta-architecture.asciidoc_client-architecture]]
=== Client Architecture
...
[[meta-architecture.asciidoc_dialog-component]]
==== Dialog Component
...
[[meta-architecture.asciidoc_dialog-container]]
==== Dialog Container
...
[[meta-architecture.asciidoc_application-server-access]]
...
[[meta-architecture.asciidoc_dialog-container-architecture]]
...
[[meta-architecture.asciidoc_application]]
==== Application
...
[[meta-architecture.asciidoc_configuration-management]]
...
[[meta-architecture.asciidoc_dialog-management]]
==== Dialog Management
...
[[meta-architecture.asciidoc_service-registry]]
==== Service Registry
...
[[meta-architecture.asciidoc_dialog-component-architecture]]
...
[[meta-architecture.asciidoc_presentation-layer]]
==== Presentation Layer
...
[[meta-architecture.asciidoc_dialog-core-layer]]
==== Dialog Core Layer
...
[[meta-architecture.asciidoc_interactions-between-dialog-components]]
...
[[meta-architecture.asciidoc_appendix]]
== Appendix

[[meta-architecture.asciidoc_notes-about-quasar-client]]
...
[[meta-architecture.asciidoc_references]]
== References
