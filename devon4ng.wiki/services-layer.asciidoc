...
[[services-layer.asciidoc_boundaries]]
== Boundaries
...
TIP: A more profound implementation taken from a real-life project can be found here (xref:cookbook-abstract-class-store.asciidoc[Abstract Class Store]).
...
[[services-layer.asciidoc_use-case-service]]
== Use Case Service
...
[[services-layer.asciidoc_adapter]]
== Adapter
...
For further information on backend interaction see xref:guide-consuming-rest-services.asciidoc[Consuming REST Services]
...
[[services-layer.asciidoc_interaction-of-smart-components-through-the-services-layer]]
...
[[services-layer.asciidoc_pattern]]
=== Pattern
...
[[services-layer.asciidoc_example]]
=== Example
