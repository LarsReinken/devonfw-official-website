...
[[guide-ngrx-effects.asciidoc_obtaining-the-recommendation-list-from-the-server]]
...
xref:guide-ngrx-entity.asciidoc[Continue reading how to simplify CRUD (Create Read Update Delete) operations using @ngrx/entity].