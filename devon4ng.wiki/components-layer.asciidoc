...
* how to structure the components layer (see xref:guide-file-structure.asciidoc[File Structure Guide])
* decompose components into maintainable chunks (see xref:guide-component-decomposition.asciidoc[Component Decomposition Guide])
* handle component interaction
* manage calls to the services layer
* apply a maintainable data and eventflow throughout the component tree

[[components-layer.asciidoc_smart-and-dumb-components]]
...
[[components-layer.asciidoc_interaction-of-smart-and-dumb-components]]
