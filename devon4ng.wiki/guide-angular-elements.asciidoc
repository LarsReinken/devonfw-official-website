...
[[guide-angular-elements.asciidoc]]
= Angular Elements

[[guide-angular-elements.asciidoc_what-are-angular-elements]]
...
[[guide-angular-elements.asciidoc_why-use-angular-elements]]
...
[[guide-angular-elements.asciidoc_negative-points-about-elements]]
...
[[guide-angular-elements.asciidoc_how-to-use-angular-elements]]
...
[[guide-angular-elements.asciidoc_yarn]]
===== YARN
...
[[guide-angular-elements.asciidoc_preparing-the-components-in-the-modules]]
...
[[guide-angular-elements.asciidoc_a-component-example]]
=== A component example
...
[[guide-angular-elements.asciidoc_solving-the-error]]
=== Solving the error
...
[[guide-angular-elements.asciidoc_changing-the-target]]
===== Changing the target 
...
[[guide-angular-elements.asciidoc_installing-polyfaces]]
...
[[guide-angular-elements.asciidoc_building-the-angular-element]]
...
[[guide-angular-elements.asciidoc_building-with-ngx-build-plus-recommended]]
...
[[guide-angular-elements.asciidoc_extra-parameters]]
====== Extra parameters
...
[[guide-angular-elements.asciidoc_using-the-angular-element]]
...
[[guide-angular-elements.asciidoc_angular-element-within-another-angular-project]]
...
[[guide-angular-elements.asciidoc_copy-bundled-script-and-css-to-resources]]
=== Copy bundled script and css to resources

First copy the generated `.js` and `.css` inside assets in the corresponding folder.

[[guide-angular-elements.asciidoc_add-bundled-script-to-angular.json]]
...
[[guide-angular-elements.asciidoc_using-angular-element]]
=== Using Angular Element

There are two ways that `Angular Element` can be used:

[[guide-angular-elements.asciidoc_create-component-dynamicly]]
...
[[guide-angular-elements.asciidoc_using-it-directly]]
===== Using it directly
