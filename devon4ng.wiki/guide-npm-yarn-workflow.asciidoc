...
[[guide-npm-yarn-workflow.asciidoc]]
= Package Managers Workflow

[[guide-npm-yarn-workflow.asciidoc_introduction]]
== Introduction
...
[[guide-npm-yarn-workflow.asciidoc_package.json]]
=== Package.json
...
:numbered:
[[guide-npm-yarn-workflow.asciidoc_content-of-package.json]]
...
:numbered:
[[guide-npm-yarn-workflow.asciidoc_scripts]]
==== Scripts
...
:numbered:
[[guide-npm-yarn-workflow.asciidoc_managing-dependencies]]
...
:numbered:
[[guide-npm-yarn-workflow.asciidoc_npm]]
==== npm
...
:numbered:
[[guide-npm-yarn-workflow.asciidoc_yarn]]
==== Yarn
...
[[guide-npm-yarn-workflow.asciidoc_global-package]]
==== Global package
...
:numbered:
[[guide-npm-yarn-workflow.asciidoc_package-version]]
==== Package version
...
:numbered:
[[guide-npm-yarn-workflow.asciidoc_problems-you-may-encounter]]
...
[[guide-npm-yarn-workflow.asciidoc_recomendations]]
==== Recomendations
