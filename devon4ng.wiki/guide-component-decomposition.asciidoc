...
[[guide-component-decomposition.asciidoc_defining-components]]
== Defining Components
...
[[guide-component-decomposition.asciidoc_defining-state]]
== Defining state
...
[[guide-component-decomposition.asciidoc_when-are-dumb-components-needed]]
